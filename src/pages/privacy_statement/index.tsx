...
const index = () => {
  return (
    <div className="p-20">
      ...
      <div>
        PRIVACY STATEMENT ---- SECTION 1 - WHAT DO WE DO WITH YOUR INFORMATION?
        <br />
        <br />
        ...
        verify your credit card, place an order, we imply that you consent to
        ...
        of your information, at anytime, by mailing us at support@oyetrader.com
        <br />
        <br />
        <br />
        ...
        <br />
        <br />
        We use cookies to maintain the session of the user. It is not used to
        ...
        information, mail at Suport@oyetrader.com
      </div>
    </div>
  );
};
